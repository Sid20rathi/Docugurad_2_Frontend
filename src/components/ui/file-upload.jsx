  ...
  return (
    (<div className="w-full" {...getRootProps()}>
      <motion.div
        onClick={handleClick}
        whileHover="animate"
        className="p-10 group/file block rounded-lg cursor-pointer w-full relative overflow-hidden shadow-xs ">
        <input
          ref={fileInputRef}
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <p
            className=" z-20 font-sans font-normal text-neutral-400 dark:text-neutral-400 text-base underline">
...
export function GridPattern() {
  ...
  return (
    (<div
      className="flex bg-gray-300 dark:bg-neutral-900 shrink-0 flex-wrap justify-center items-center gap-x-px gap-y-px  scale-105 shadow-md ">
